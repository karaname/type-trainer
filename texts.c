...
char *generate_text(char *type_lang)
{
  ...
  if (strcmp(type_lang, "Russion") == 0) {
    char *ru_arr[5];
    ru_arr[0] = "В 1901 году Тейлор снимала меблированные комнаты в мичиганском городе\n\
...
повороте реки.";
    ...
    ru_arr[1] = "Первым известным прообразом сложной машины, как устройства для\n\
...
падающей воды (гидроэнергии) в энергию вращательного движения.";
    ...
    ru_arr[2] = "Основой устройства механической машины являются механизмы\n\
...
— исполнительным механизмом.";
    ...
    ru_arr[3] = "Идею нового фильма предложил Яков Костюковский, прочитавший\n\
...
сыграет в ней «скромного служащего отнюдь не героического вида и нрава»";
    ...
    ru_arr[4] = "В 1882 году на федеральном уровне был принят Акт об исключении\n\
...
до Второй мировой войны.";
  ...
  if (strcmp(type_lang, "English") == 0) {
    char *en_arr[5];
    en_arr[0] = "I never spend much time in school but I taught ladies plenty. It's true\n\
...
Cause I'm the unknown stuntman that makes Eastwood look so fine.";
    ...
    en_arr[1] = "This is my boss, Jonathan Hart, a self-made millionaire, he's quite a guy.\n\
...
ain't easy, cause when they met it was MURDER!";
    ...
    en_arr[2] = "Hong Kong Phooey, number one super guy. Hong Kong Phooey, quicker\n\
...
quicker than the human eye. Hong Kong Phooey, he's fan-riffic!";
    ...
    en_arr[3] = "Mutley, you snickering, floppy eared hound. When courage is needed,\n\
...
that pigeon now.";
    ...
    en_arr[4] = "It took seven years of planning and 70,000 volunteers to make\n\
